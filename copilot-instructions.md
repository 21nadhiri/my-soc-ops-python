...
When working on the frontend, keep the visual system consistent and distinctive:

- Use CSS variables for color, glass, and metallic chrome styles.
- Prioritize high-contrast blue/metallic palettes and refined glassmorphism.
- Keep motion subtle: staggered fade-ins, soft glows, and smooth hover transitions.
- Use modern font choices and typography hierarchy to elevate the interface.
- Avoid generic UI patterns; favor clean, corporate layouts with geometric structure.
